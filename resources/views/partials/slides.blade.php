...
<div id="slideshow-container" class="container">
    ...
    <div id="wowslider-container1" class="playpause">
        <div class="ws_images">
            <ul>
                @foreach($slides as $slide)
                    <li>
                        <a href="{{$slide->btn_href ? url($slide->btn_href) : ''}}"><img src="{{ $slide->desktop_src }}" alt="{{ $slide->title }}" title="{{ $slide->title }}" id="wows1_{{ $loop->index }}"/></a>
                    </li>
                @endforeach
            </ul>
        </div>
        <div class="ws_bullets">
            <div>
            @foreach ($slides as $slide)
                <a href="#" title="{{ $slide->title }}"><span><img src="{{ $slide->desktop_src }}" alt="{{ $slide->title }}"/>1</span></a>
            @endforeach
            </div>
        </div>
